...
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deberia devolver null si el medico no esta disponible en la fecha")
    void elegirMedicoAleatorioDisponibleEnLaFechaEscenario1() {
        ...
        var medico = registrarMedico("Medico1", "medico@gmail.com", "123456789", Especialidad.CARDIOLOGIA);
        var paciente = registrarPaciente("Paciente1", "paciente1@gmail.com", "123456789");
    ...
    @Test
    @DisplayName("Deberia devolver médico cuando esta disponible en la fecha")
